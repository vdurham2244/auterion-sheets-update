...
let updateResults = {
  flights: { total: 0, added: 0 },
  vehicles: { total: 0, added: 0 },
  vehicleDetails: { total: 0 }
};
...
async function updateFlightsSheet() {
  ...
  // Store total flights
  updateResults.flights.total = flights.length;
  ...
  // Store added flights count
  updateResults.flights.added = newFlights.length;
...
async function updateVehiclesSheet() {
  ...
  // Store total vehicles
  updateResults.vehicles.total = vehicles.length;
  ...
  // Store added vehicles count
  updateResults.vehicles.added = newVehicles.length;
...
async function updateVehicleDetailsSheet() {
  ...
  // Store vehicle details count
  updateResults.vehicleDetails.total = vehicles.length;
...
/**
 * Get the results of the update operation
 */
